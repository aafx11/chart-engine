import type { Guide, Ctor } from './interface.d';
...
const createGuide = (guide: Guide, options: any) => {
  return (renderer: Renderer, scale: any, coordinate: any) => guide(renderer, scale, coordinate, options);
};

const createScaleQ = (ctor: Ctor, options: any) => {
